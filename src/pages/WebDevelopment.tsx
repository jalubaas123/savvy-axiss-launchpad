...
import { Globe, CheckCircle2, Zap, Smartphone, Search, Shield, Palette, ShoppingCart, ArrowRight, MessageCircle, Star } from 'lucide-react';
...
const services = [{
  ...
  icon: Smartphone,
  name: 'Landing Pages',
  description: 'High-converting landing pages for your campaigns and products'
}, {
  icon: Globe,
  name: 'Portfolio Sites',
  description: 'Stunning portfolio websites for freelancers and creatives'
}];
const features = [{
  icon: Smartphone,
  ...
  description: 'SSL & regular backups'
}];
const packages = [{
  name: 'Starter',
  price: '₹9,999',
  description: 'Perfect for personal & small businesses',
  features: ['5-page responsive website', 'Mobile-friendly design', 'Contact form', 'Social media integration', 'Basic SEO setup', '1 year free hosting'],
  popular: false
}, {
  name: 'Professional',
  price: '₹24,999',
  description: 'Ideal for growing businesses',
  features: ['10-page responsive website', 'Custom design', 'Blog integration', 'Google Analytics', 'Advanced SEO', 'WhatsApp chat widget', '2 years free hosting', '3 months support'],
  popular: true
}, {
  name: 'E-Commerce',
  price: '₹49,999',
  description: 'Complete online store solution',
  features: ['Full e-commerce functionality', 'Payment gateway integration', 'Inventory management', 'Order tracking', 'Admin dashboard', 'Product catalog (up to 100)', '2 years free hosting', '6 months support'],
  popular: false
}];
const testimonials = [{
  name: 'Rajesh Kumar',
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          duration: 0.6
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6 text-success">
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          ...
          once: true
            ...
            {services.map(service => <motion.div key={service.name} variants={itemVariants} className="group p-6 rounded-xl bg-card border border-border hover:border-secondary/50 transition-all duration-300 text-center card-hover">
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          ...
          once: true
            ...
            {features.map(feature => <motion.div key={feature.title} variants={itemVariants} className="flex flex-col items-center text-center p-6">
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          ...
          once: true
            ...
            {testimonials.map(testimonial => <motion.div key={testimonial.name} variants={itemVariants} className="p-6 rounded-xl bg-card border border-border">
