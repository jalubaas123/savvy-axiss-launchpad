...
const testimonials: Array<{ name: string; business: string; role: string; quote: string; rating: number; image: string; results: string }> = [
  ...
  {
    name: 'Priya Lakshmi',
    business: 'Bloom Florist, Anna Nagar',
    role: 'Founder',
    quote: 'We needed an online presence fast. The team delivered a clean, mobile-friendly site with simple updates. Our website orders are growing every month.',
    rating: 5,
    image: '/placeholder.svg',
  ...
  },
  {
    ...
    role: 'Director',
    quote: 'From design to deployment everything was smooth. They understood our requirements and delivered a professional website that our clients actually use.',
    rating: 5,
    image: '/placeholder.svg',
